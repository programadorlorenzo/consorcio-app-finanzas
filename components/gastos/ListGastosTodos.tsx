      ...
      <View style={stylesListGastos.pagoModalOverlay}>
        <SafeAreaView style={stylesListGastos.pagoModalContainer}>
          ...
          <View style={stylesListGastos.pagoModalHeader}>
            ...
            <TouchableOpacity
              onPress={onClose}
              style={stylesListGastos.pagoModalCloseButton}
            >
          ...
          <View style={stylesListGastos.pagoGastoInfo}>
            <Text style={stylesListGastos.pagoGastoDescription}>
              {gasto.descripcion}
            </Text>
          ...
          <ScrollView style={stylesListGastos.pagoModalContent}>
            ...
            <View style={stylesListGastos.pagoFieldContainer}>
              ...
              <Text style={stylesListGastos.pagoFieldValue}>
                {formData.tipo}
              </Text>
            </View>
            ...
            <View style={stylesListGastos.pagoFieldContainer}>
              ...
              <View style={stylesListGastos.pagoAmountContainer}>
                <Text style={stylesListGastos.pagoAmountCurrency}>
                  {formData.moneda}
                </Text>
                <Text style={stylesListGastos.pagoAmountValue}>
                  {formData.importe}
                </Text>
              </View>
            </View>
            ...
            {/* Número de operación */}
            <View style={stylesListGastos.pagoFieldContainer}>
              <Text style={stylesListGastos.pagoFieldLabel}>
                Número de Operación
              </Text>
              <TextInput
                ...
                onChangeText={(text) =>
                  setFormData({ ...formData, numeroOperacion: text })
                }
          ...
          <View style={stylesListGastos.pagoModalFooter}>
            <TouchableOpacity
              ...
              disabled={isLoading}
            >
              <Text style={stylesListGastos.pagoCancelButtonText}>
                Cancelar
              </Text>
            </TouchableOpacity>
